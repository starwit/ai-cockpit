...
public class ActionControllerAcceptanceTest extends AbstractControllerAcceptanceTest<ActionEntity> {

        final static Logger LOG = LoggerFactory.getLogger(ActionControllerAcceptanceTest.class);
        private static final String restpath = "/api/actions/";

        private JacksonTester<ActionEntity> jsonTester;
        ...
        @Override
        public JacksonTester<ActionEntity> getJsonTester() {
                return jsonTester;
        }
        ...
        public void canCreate() throws Exception {
                // given
                // ActionEntity entity = readFromFile(data + "Action.json");
                ...
                // ActionEntity entityresult = mapper.readValue(response.getContentAsString(),
                // ActionEntity.class);
        ...
        public void isValidated() throws Exception {
                // given
                // ActionEntity entity = readFromFile(data + "Action-wrong.json");
        ...
        public void canRetrieveById() throws Exception {
                ...
                // ActionEntity entity = readFromFile(data + "Action.json");
                // MockHttpServletResponse response = create(entity);
                // ActionEntity entity2 = mapper.readValue(response.getContentAsString(),
                // ActionEntity.class);
