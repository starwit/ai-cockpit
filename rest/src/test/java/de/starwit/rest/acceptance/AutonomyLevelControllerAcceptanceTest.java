...
public class AutonomyLevelControllerAcceptanceTest extends AbstractControllerAcceptanceTest<AutonomyLevelEntity> {
        ...
        public void canCreate() throws Exception {
                ...
                // AutonomyLevelEntity entityresult =
                // mapper.readValue(response.getContentAsString(), AutonomyLevelEntity.class);
        ...
        public void canRetrieveById() throws Exception {
                ...
                // AutonomyLevelEntity entity = readFromFile(data + "AutonomyLevel.json");
                // MockHttpServletResponse response = create(entity);
                // AutonomyLevelEntity entity2 = mapper.readValue(response.getContentAsString(),
                // AutonomyLevelEntity.class);
