...
public class AutonomyLevelControllerAcceptanceTest extends AbstractControllerAcceptanceTest<AutonomyLevelEntity> {
    ...
    @Override
    public JacksonTester<AutonomyLevelEntity> getJsonTester() {
        return jsonTester;
    }
    ...
    public void canCreate() throws Exception {
        // given
//        AutonomyLevelEntity entity = readFromFile(data + "AutonomyLevel.json");
...
//        AutonomyLevelEntity entityresult = mapper.readValue(response.getContentAsString(), AutonomyLevelEntity.class);
//        assertThat(entityresult.getBranch()).isEqualTo("v2");
    ...
    public void isValidated() throws Exception {
        // given
//        AutonomyLevelEntity entity = readFromFile(data + "AutonomyLevel-wrong.json");
...
//        AutonomyLevelEntity entity = readFromFile(data + "AutonomyLevel.json");
//        MockHttpServletResponse response = create(entity);
//        AutonomyLevelEntity entity2 = mapper.readValue(response.getContentAsString(), AutonomyLevelEntity.class);
