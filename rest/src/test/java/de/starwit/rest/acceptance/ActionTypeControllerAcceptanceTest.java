...
public class ActionTypeControllerAcceptanceTest extends AbstractControllerAcceptanceTest<ActionTypeEntity> {

        final static Logger LOG = LoggerFactory.getLogger(ActionTypeControllerAcceptanceTest.class);
        private static final String restpath = "/api/actiontypes/";

        private JacksonTester<ActionTypeEntity> jsonTester;
        ...
        @Override
        public JacksonTester<ActionTypeEntity> getJsonTester() {
                return jsonTester;
        }
        ...
        public void canCreate() throws Exception {
                // given
                // ActionTypeEntity entity = readFromFile(data + "ActionType.json");
                ...
                // ActionTypeEntity entityresult =
                // mapper.readValue(response.getContentAsString(), ActionTypeEntity.class);
        ...
        public void isValidated() throws Exception {
                // given
                // ActionTypeEntity entity = readFromFile(data + "ActionType-wrong.json");
        ...
        public void canRetrieveById() throws Exception {
                ...
                // ActionTypeEntity entity = readFromFile(data + "ActionType.json");
                // MockHttpServletResponse response = create(entity);
                // ActionTypeEntity entity2 = mapper.readValue(response.getContentAsString(),
