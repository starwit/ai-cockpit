...
public class TrafficIncidentTypeControllerAcceptanceTest
                extends AbstractControllerAcceptanceTest<TrafficIncidentTypeEntity> {
        ...
        public void canCreate() throws Exception {
                // given
                // TrafficIncidentTypeEntity entity = readFromFile(data +
                // "TrafficIncidentType.json");
                ...
                // TrafficIncidentTypeEntity entityresult =
                // mapper.readValue(response.getContentAsString(),
                // TrafficIncidentTypeEntity.class);
        ...
        public void isValidated() throws Exception {
                // given
                // TrafficIncidentTypeEntity entity = readFromFile(data +
                // "TrafficIncidentType-wrong.json");
        ...
        public void canRetrieveById() throws Exception {
                ...
                // "TrafficIncidentType.json");
                // MockHttpServletResponse response = create(entity);
                // TrafficIncidentTypeEntity entity2 =
                // mapper.readValue(response.getContentAsString(),
                // TrafficIncidentTypeEntity.class);
