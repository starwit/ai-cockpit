...
const translationEnEN = {
    ...
    "decision.action": "action Actions",
    "decision.action.header4standardvalues": "Add Standard Values for action Actions",
    "decision.button.acknowledged": "Acknowledged",
    "decision.button.reportmistake": "Report Mistake",
    "decision.state": "State",
    "action": "Action",
    "action.title": "action Actions",
    "action.create.title": "Create action Action",
    "action.update.title": "Edit action Action",
    "action.id": "id",
    ...
    "menu.config.actiontype": "action Action Config",
    "menu.config.decisiontype": "Incidend Type Config",
    "actiontype.heading": "action Action Types",
