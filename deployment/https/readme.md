...
* 7. checkout project and go to `/ai-cockpit/deployment/https`
...
* 10. execute `ai-cockpit-docker-compose up -d` and `env-docker-compose up -d`
...
* go to https://pb.startwit.de/auth, login and create user for ai-cockpit
